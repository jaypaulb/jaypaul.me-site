{please note it is a single page site.  all content from the scraper including the scripts for it must reside in the @scraper folder and nothing outside for this process.
